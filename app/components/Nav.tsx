    ...
    <>
      <nav id="header" className="w-full z-30 top-0 py-1">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
          ...
          >
            <button
              className="no-underline hover:text-black inline-flex items-center mr-3"
              onClick={openModal}
            >
              <svg
            ...
            >
              ...
              {typeof cartItems === "number" && (
                <span className="absolute top-3/4 -right-1/2 bg-black text-white rounded-full px-2 py-1 text-xs">
                  {cartItems}
                </span>
              )}
            </Link>
      ...
      <UserModal show={userModalOpen} onClose={closeModal} />
    </>
  );
}
